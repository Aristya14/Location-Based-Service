    ...
    <div class="container py-4 justify-content-center">
        <div class="row">
            <div class="col-md-6 col-xs-6 mb-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img class="img-fluid" width="200" src="{{ asset('storage/uploads/' . $spaces->image) }}"
                            alt="">
                        </p>
                        <h4>
                            <strong>Action</strong>
                        </h4>
                        <form onsubmit="return confirm('Apakah Anda Yakin Menghapus Data ini ?');" action="{{ route('space.destroy', $spaces->id) }}" method="POST">
                        @csrf
                        @method('delete')
            ...
            <div class="col-md-6 col-xs-6">
                <div class="card">
                    <div class="card-body">
                        <h4><strong>Detail Location</strong></h4>
                        <div id="map"></div>
                    </div>
                </div>
            </div>
